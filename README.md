...
Hydra is built completely natively for Android using modern, declarative architecture.

- **Language**: Kotlin
- **Architecture**: MVI / Pure Functional FSM (Finite State Machine) using Redux-style reducers.
- **UI**: Jetpack Compose (Material 3)
- **Persistence**: Room Database & Preferences DataStore
- **Background Work**: Foreground Services & AlarmManager
- **Coroutines & Flows**: For reactive state propagation and background ticker logic.
